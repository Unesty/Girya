...
define config.name = _("На 16 килограммов тяжелее")
...
define config.sample_sound = "audio/bonk.ogg"
define config.sample_voice = "audio/sample-voice.ogg"


## Раскомментируйте следующую строчку, чтобы настроить аудиофайл, илогроторый будет
## проигрываться в главном меню. Этот файл продолжит проигрываться во время
## игры, если не будет остановлен, или не начнёт проигрываться другой аудиофайл.

define config.main_menu_music = "audio/edm.ogg"
...
define config.save_directory = "Girya-1614450669"
